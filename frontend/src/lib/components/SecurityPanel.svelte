	...
	<div class="card-body">
		...
		<form onsubmit={updatePassword} class="flex max-w-md flex-col gap-4">
			<div class="form-control">
				...
				<input type="password" bind:value={currentPass} required class="input-bordered input" />
			</div>
			...
			<div class="form-control">
				...
				<input type="password" bind:value={confirmPass} required class="input-bordered input" />
			</div>
			<div class="mt-4">
